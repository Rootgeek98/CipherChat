<html>
    <head>
        <title>CipherChat | Firebase Cloud Messaging</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="shortcut icon" href="http://www.gstatic.com/mobilesdk/160503_mobilesdk/logo/favicon.ico">
    ...
    <body>
        ...
        if ($include_image) {
            $push->setImage('https://cdn.luxe.digital/media/2020/12/16175821/most-expensive-cars-2021-Maserati-MC20-luxe-digital%402x.jpg');
        } else {
            $push->setImage('');
        }
        ...
        <div class="container">
            <div class="fl_window">
                <div><img src="firebase.png" width="200" alt="Firebase"/></div>
                <br/>
                <?php if ($json != '') { ?>
